...
export default function Features() {
  return (
    <section className="relative">
      {/* ... (keeping all the existing UI code) ... */}
        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <p className="text-lg text-orange-200/65">
              Our AI-powered system optimizes autobot navigation in complex
              workshop environments, ensuring efficient pathfinding and
              collision avoidance for seamless operations.
            </p>
          </div>
          <div className="flex justify-center pb-4 md:pb-12" data-aos="fade-up">
            <Image
              ...
              width={1104}
              height={384}
              alt="Autobot Navigation Features"
            />
          </div>
          {/* Items */}
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              <p className="text-orange-200/65">
                Our algorithm calculates the most efficient routes for autobots,
                minimizing travel time and energy consumption in complex
                workshop layouts.
              </p>
            </article>
            <article>
              ...
              <p className="text-orange-200/65">
                Advanced sensors and predictive algorithms enable autobots to
                dynamically adjust their paths, preventing collisions with
            ...
            <article>
              ...
              <p className="text-orange-200/65">
                Our system continuously learns from the workshop environment,
                adapting to changes in layout and traffic patterns for improved
            ...
            <article>
              ...
              <p className="text-orange-200/65">
                Sophisticated algorithms enable seamless coordination between
                multiple autobots, optimizing overall workshop productivity and
            ...
            <article>
              ...
              <p className="text-orange-200/65">
                Our system intelligently assigns tasks to autobots based on
                their location, current workload, and overall workshop
            ...
            <article>
              ...
              <p className="text-orange-200/65">
                Comprehensive analytics provide insights into autobot
                performance, traffic patterns, and potential areas for
                improvement in workshop layout and processes.
              </p>
            </article>
          </div>
        </div>
